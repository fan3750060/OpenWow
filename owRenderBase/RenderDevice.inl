...
template< typename T >
std::shared_ptr<Buffer> IRenderDevice::CreateVertexBuffer(const T& data)
{
...
template< typename T >
std::shared_ptr<Buffer> IRenderDevice::CreateVertexBuffer(const T* data, uint32 count)
{
	static_assert(false, "This function must be specialized.");
	return NULL;
}
...
template<typename T>
std::shared_ptr<Buffer> IRenderDevice::CreateIndexBuffer(const T& data)
{
	static_assert(false, "This function must be specialized.");
	return NULL;
}
...
template<typename T>
std::shared_ptr<Buffer> IRenderDevice::CreateIndexBuffer(const T* data, uint32 count)
{
	static_assert(false, "This function must be specialized.");
	return NULL;
}
