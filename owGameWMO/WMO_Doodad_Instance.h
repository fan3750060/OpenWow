...
{
public:
	CWMO_Doodad_Instance(std::weak_ptr<SceneNode> _parent, std::shared_ptr<M2> _mdxObject, const std::weak_ptr<const WMO_Group> _parentGroup, uint32 _index, const SWMO_Doodad_PlacementInfo& _placement);
