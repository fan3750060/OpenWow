...
void Material::SetGlobalAmbientColor(cvec4 globalAmbient)
{
	m_pProperties->m_GlobalAmbient = globalAmbient;
	m_Dirty = true;
}

cvec4 Material::GetAmbientColor() const
{
	return m_pProperties->m_AmbientColor;
}

void Material::SetAmbientColor(cvec4 ambient)
{
	m_pProperties->m_AmbientColor = ambient;
	m_Dirty = true;
}

cvec4 Material::GetDiffuseColor() const
{
	return m_pProperties->m_DiffuseColor;
}

void Material::SetDiffuseColor(cvec4 diffuse)
{
	m_pProperties->m_DiffuseColor = diffuse;
	m_Dirty = true;
}

cvec4 Material::GetEmissiveColor() const
{
	return m_pProperties->m_EmissiveColor;
}

void Material::SetEmissiveColor(cvec4 emissive)
{
	m_pProperties->m_EmissiveColor = emissive;
	m_Dirty = true;
}

cvec4 Material::GetSpecularColor() const
{
	return m_pProperties->m_SpecularColor;
}

void Material::SetSpecularColor(cvec4 specular)
{
...
cvec4 Material::GetReflectance() const
{
	return m_pProperties->m_Reflectance;
}

void Material::SetReflectance(cvec4 reflectance)
{
