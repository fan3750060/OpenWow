...
__DBC_TVALUE(uint32, FootprintID, 8);
__DBC_TVALUE(float_t, FootprintTextureLength, 9);	// most time 18.0
__DBC_TVALUE(float_t, FootprintTextureWidth, 10);	// mostly 12, others are 0.0 - 20.0
__DBC_TVALUE(float_t, FootprintParticleScale, 11);	// mostly 1.0, others are 0.0 - 5.0
